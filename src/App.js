...
class App extends Component {
  ...
  render() {
    ...
    const details = props => {
      ...
      let current = this.state.listdata.find(ind => ind.title.toLowerCase() === name.toLowerCase());
    ...
    return (
      <>
        <Switch>
          <Route exact path="/" render={() => <div><Search handleChange={this.handleChange} val={this.state.searchString} />
            <List data={filteredData} /></div>} />
